...
```
To answer this question, I had to sort choco dataset into two factors: Ingredients and Rating. With this, I could compare the correlation between ingredients in the chococalte to see if it had any affect of the rating of the chocolate. The graph shows that there is not a very high correlation between the two factors.
